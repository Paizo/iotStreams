...
public class AbstractIOTDeviceService<T> implements IOTDeviceService {
    ...
    void determineClassType() {
        this.genericType = (Class<T>) GenericTypeResolver.resolveTypeArgument(getClass(), AbstractIOTDeviceService.class);
    }
